...
def main(args):
    ...
    #load 20
    model_path = f'model/resnet_18_contrastive_epoch_6.pth'
    ...
    for epoch in range(n_epoch):
        ...
        if epoch % args.test_interval == 0 or epoch == (n_epoch-1):
            ...
            torch.save(model.state_dict(), f'model/resnet_18_contrastive_large_epoch_{epoch}.pth')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-n_valid', default=256, type=int, help='n_valid')
